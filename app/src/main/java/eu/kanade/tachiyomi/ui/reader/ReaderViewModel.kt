...
class ReaderViewModel @JvmOverloads constructor(
    ...
    suspend fun init(mangaId: Long, initialChapterId: Long /* SY --> */, page: Int?/* SY <-- */): Result<Boolean> {
        ...
        return withIOContext {
            try {
                ...
                if (manga != null) {
                    // SY -->
                    // FIX: Ensure sourceManager is ready, but proceed if it takes too long to avoid freeze
                    try {
    ...
    fun onPageSelected(page: ReaderPage, currentPageText: String /* SY --> */, hasExtraPage: Boolean /* SY <-- */) {
        ...
        // FIX: Force to IO dispatcher to avoid UI jank
    ...
    suspend fun updateHistory() {
        // FIX: Run on IO to prevent main thread blocks
        withIOContext {
